        ...
        <div class="container">
                ...
                <form role="form" id="registration-form" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                   ...
                   <?php echo $feedback['message']; ?>
                       ...
                       <div class="form-group">
                           <input type="hidden" name="client_id" value="<?php if(isset($frm_data['client_id'])){  echo $frm_data['client_id'];} ?>"/>
		 ...
		 data-validation-error-msg="Please Enter Your Full Name">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" value="<?php if(isset($frm_data['email_address'])){  echo $frm_data['email_address'];} ?>" id="exampleInputEmail1" disabled="disabled" name="email_address" >
                    </div>
                          <div class="form-group">
  ...
  ?>
   ...
   <input type="hidden" name="location" value="<?php if(isset($frm_data['location_id'])){  echo $frm_data['location_id'];} ?>"/>
  ...
  ?>
                      ...
                      <input type="hidden" name="old_cl_picture" value="<?php  if(isset($frm_data['cl_picture'])){echo $frm_data['cl_picture'];}  ?>"/>  
